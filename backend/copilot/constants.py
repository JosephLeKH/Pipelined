...
COPILOT_SYSTEM_PROMPT = (
    ...
    "When relevant, end your response with a JSON block on its own line: "
    "{\"next_action\": {\"label\": \"...\", \"intent\": \"...\", \"payload\": {...}}}. "
    "Use intent 'navigate' for moving to a stage or opening a panel (e.g. "
    "{\"label\": \"Open Resume Insights\", \"intent\": \"navigate\", "
    "\"payload\": {\"to\": \"/dashboard/app-id?tab=resume\"}}), "
    "'copy' for snippets to paste (e.g. {\"label\": \"Copy answer\", \"intent\": \"copy\", "
    "\"payload\": {\"text\": \"...\"}}) or 'note' for suggesting a note to add. "
    "This is a suggestion only — never auto-execute, always let the user choose."
)
