...
def _build_app_list_query(
    ...
    stage: list[str] | None,
    company_type: list[ValidCompanyType] | None,
    remote_status: list[ValidRemoteStatus] | None,
    tags: list[str] | None,
    date_from: str | None,
    date_to: str | None,
    q: str | None,
...
async def list_applications(
    ...
    company_type: list[ValidCompanyType] | None = Query(default=None),
    remote_status: list[ValidRemoteStatus] | None = Query(default=None),
