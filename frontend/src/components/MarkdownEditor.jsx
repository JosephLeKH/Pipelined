      ...
      <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 mb-2">
            ...
            <button
              ...
              className={`px-3 py-1 text-xs font-medium capitalize transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500/30 ${
                activeTab === tab
                  ...
                  : "text-gray-500 hover:text-gray-700 transition-colors dark:hover:text-gray-300"
              }`}
            >
              {tab}
            </button>
        ...
        <div className="relative">
          <button
            ...
            className="rounded p-1 text-gray-500 hover:text-gray-600 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-500/30 dark:hover:text-gray-300"
          >
