...
function FollowUpBanner({ followUpsDue, onView }) {
  ...
  return (
    <div
      className="mb-4 flex items-center justify-between rounded-lg border border-yellow-200 bg-yellow-50 px-4 py-3 dark:border-yellow-700/50 dark:bg-yellow-900/20"
      role="alert"
