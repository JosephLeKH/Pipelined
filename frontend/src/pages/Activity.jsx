  ...
  return (
    ...
    >
      ...
      <div className="mt-1.5 flex-shrink-0">
        <span className={`block h-3 w-3 rounded-full ${dotClass} ring-2 ring-white dark:ring-gray-900`} />
      </div>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <main className="mx-auto max-w-2xl px-4 py-8">
        ...
        {isLoading ? (
          ...
          <div className="rounded-lg border border-gray-200 bg-white px-6 dark:border-gray-700 dark:bg-gray-800">
            {/* Vertical line + entries */}
            <div className="relative border-l-2 border-gray-100 pl-4 dark:border-gray-700">
