  ...
  theme: {
    extend: {
      colors: {
        ...
        // Linear redesign semantic tokens (PRD-00 / PRD-02)
        "surface-0": "#FFFFFF",
        "surface-1": "#FAFAFA",
      ...
      fontSize: {
        "display-xl": ["3.5rem", { lineHeight: "1.05", letterSpacing: "-0.030em", fontWeight: "600" }],
        "display-lg": ["2.5rem", { lineHeight: "1.1", letterSpacing: "-0.025em", fontWeight: "600" }],
        "display-md": ["1.75rem", { lineHeight: "1.15", letterSpacing: "-0.022em", fontWeight: "600" }],
      },
      transitionDuration: {
        120: "120ms",
      },
